    ...
    <footer class="bg-dark text-white py-4 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5>Color System</h5>
                    <p>A comprehensive color management tool built by <a class="text-light" href="https://soft.io.vn" target="_blank">Tung Pham</a> and <a class="text-light" href="https://tanphatdigital.com" target="_blank">Tan Phat Digital</a></p>
                </div>
